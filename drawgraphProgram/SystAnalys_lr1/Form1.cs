...
namespace SystAnalys_lr1
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            List<Point> m23 = new List<Point>();

            m23.Add(new Point(204, 438));
            m23.Add(new Point(247, 571));
            m23.Add(new Point(490, 530));
            m23.Add(new Point(574, 708));
            m23.Add(new Point(642, 728));
            m23.Add(new Point(739, 658));
            m23.Add(new Point(854, 794));
            m23.Add(new Point(1063, 633));
            m23.Add(new Point(1043, 575));
            m23.Add(new Point(1049, 532));
            m23.Add(new Point(931, 390));
            m23.Add(new Point(1029, 320));
            m23.Add(new Point(974, 247));
            m23.Add(new Point(878, 311));
            m23.Add(new Point(848, 277));
            m23.Add(new Point(680, 268));
            m23.Add(new Point(684, 69));
            m23.Add(new Point(797, 68));
            ...
            for (int i = 0; i < m23.Count; i++)
            {
                ...
                G.drawVertex(m23[i].X, m23[i].Y, V.Count.ToString());
